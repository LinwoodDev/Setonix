...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1407750444;
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok =
                    Ok::<_, ()>(crate::api::luau::LuauPlugin::new(api_code, api_callback))?;
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        ...
                        let output_ok = crate::api::luau::LuauPlugin::run(&*api_that_guard).await?;
                        std::result::Result::Ok(output_ok)
                    })()
                    .await,
                )
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = Ok::<_, ()>(
                            crate::api::luau::LuauPlugin::run_event(
                                &*api_that_guard,
                                api_event_type,
                                api_event,
                                api_server_event,
...
fn wire__crate__api__plugin__PluginCallback_new_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Ok::<_, ()>(crate::api::plugin::PluginCallback::new(
                    api_on_print,
                    api_process_event,
                    api_send_event,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        7 => wire__crate__api__simple__simple_adder_twin_normal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__plugin__PluginCallback_new_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
