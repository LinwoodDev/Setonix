...
class _AuthGameViewState extends State<AuthGameView> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<WorldBloc, ClientWorldState>(
                ...
                content: _isLoading
                    ? Column(
                        ...
                        children: [
                          ...
                          Text(
                              AppLocalizations.of(context).authenticateLoading),
                        ],
                      )
                    : Column(
                        mainAxisSize: MainAxisSize.min,
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return ListTile(
                                        ...
                                        subtitle: Text(account.getFingerprint(
                                            pretty: true, short: true)),
                                        onTap: () async {
                                          final bloc =
