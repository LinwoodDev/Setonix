...
class RecentGameEntryMapper extends ClassMapperBase<RecentGameEntry> {
  ...
  static const Field<RecentGameEntry, Uri> _f$location =
      Field('location', _$location);
  static DateTime? _$lastPlayed(RecentGameEntry v) => v.lastPlayed;
  static const Field<RecentGameEntry, DateTime> _f$lastPlayed =
      Field('lastPlayed', _$lastPlayed);
...
mixin RecentGameEntryMappable {
  ...
  Map<String, dynamic> toMap() {
    return RecentGameEntryMapper.ensureInitialized()
        .encodeMap<RecentGameEntry>(this as RecentGameEntry);
  }
  ...
  RecentGameEntryCopyWith<RecentGameEntry, RecentGameEntry, RecentGameEntry>
      get copyWith =>
          _RecentGameEntryCopyWithImpl<RecentGameEntry, RecentGameEntry>(
              this as RecentGameEntry, $identity, $identity);
  @override
  String toString() {
    return RecentGameEntryMapper.ensureInitialized()
        .stringifyValue(this as RecentGameEntry);
  }

  @override
  bool operator ==(Object other) {
    return RecentGameEntryMapper.ensureInitialized()
        .equalsValue(this as RecentGameEntry, other);
  }

  @override
  int get hashCode {
    return RecentGameEntryMapper.ensureInitialized()
        .hashValue(this as RecentGameEntry);
  }
}
...
class _RecentGameEntryCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? name, Uri? location, Object? lastPlayed = $none}) =>
...
abstract class SetonixSettingsCopyWith<$R, $In extends SetonixSettings, $Out>
  ...
  ListCopyWith<$R, RecentGameEntry,
...
class _SetonixSettingsCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, RecentGameEntry,
          RecentGameEntryCopyWith<$R, RecentGameEntry, RecentGameEntry>>
      get recentGames => ListCopyWith($value.recentGames,
          (v, t) => v.copyWith.$chain(t), (v) => call(recentGames: v));
  @override
  $R call(
          {String? localeTag,
          ThemeMode? theme,
