...
class ThemeController extends ChangeNotifier {
  ...
  String? get currentTheme => Hive.box("settings").get(themePrefKey, defaultValue: "system") as String?;
  ...
  set currentThemeMode(ThemeMode? themeMode) => currentTheme = EnumToString.convertToString(themeMode);
...
class ThemeControllerProvider extends InheritedWidget {
  const ThemeControllerProvider({Key? key, this.controller, required Widget child}) : super(key: key, child: child);
