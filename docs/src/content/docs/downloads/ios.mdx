...
The iOS version of Quokka is in preview and may not work as expected.
Click [here](https://github.com/LinwoodDev/Quokka/issues/244) to visit the issue on GitHub to find current known bugs and updates. Please report any issues there.
...
<TabItem label="Nightly">
  <CardGrid>
    <DownloadButton href="https://github.com/LinwoodDev/Quokka/releases/download/nightly/linwood-quokka-ios.ipa" title="IPA"/>
  </CardGrid>
</TabItem>
</Tabs>
...
\
You do need an Apple ID for sideloading Quokka. We recommend creating a new one especially for this purpose. Please log into [Apple Developer](https://developer.apple.com) at least once and accept their terms.
\
