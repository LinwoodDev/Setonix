...
The iOS version of Setonix is in preview and may not work as expected.
...
<TabItem label="Nightly">
  <CardGrid>
    <DownloadButton href="https://github.com/LinwoodDev/Setonix/releases/download/nightly/linwood-setonix-ios.ipa" title="IPA"/>
  </CardGrid>
</TabItem>
</Tabs>
...
\
You do need an Apple ID for sideloading Setonix. We recommend creating a new one especially for this purpose. Please log into [Apple Developer](https://developer.apple.com) at least once and accept their terms.
\
