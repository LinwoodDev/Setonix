...
<a className="button button--outline button--danger button--lg margin--sm" href="https://github.com/LinwoodDev/qeck/releases/download/nightly/linwood-qeck-macos.tar.gz">
  Nightly
</a>
</div>
